...
class ConvBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=1, stride=1):
        ...
        self.pool = MaxPool2dStaticSamePadding(3, 2)
        self.act = nn.ReLU()
...
class BiFPN(nn.Module):
    def __init__(self, size, feature_size=64, num_layers=2, epsilon=0.0001):
        ...
        self.p6 = ConvBlock(feature_size, feature_size, kernel_size=3, stride=2, padding=1)
        self.p7 = nn.Sequential(MaxPool2dStaticSamePadding(3, 2))
